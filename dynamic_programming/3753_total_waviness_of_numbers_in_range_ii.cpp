...
public:
    ...
    Node dfs(int pos,
        ...
        if (!tight &&
            vis[pos][prev1 + 1][prev2 + 1][started]) {
...
int main() {
    ...
    // Define test range variables
    long long num1 = 100;
    long long num2 = 200;

    // Calculate the result
    long long result = solver.totalWaviness(num1, num2);
